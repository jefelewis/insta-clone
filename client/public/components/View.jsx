    ...
    return (
      <div>
        <div>
          ...
          : this.props.render === 'Postlist' ? <Postlist posts={this.props.posts} users={this.props.users} click={this.props.click} email={this.props.email} firebase={this.props.firebase} />
