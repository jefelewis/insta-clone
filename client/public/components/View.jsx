    ...
    return (
      <div>
        <div>
          ...
          : this.props.render === 'Postlist' ? <Postlist posts={this.props.posts} users={this.props.users} click={this.props.click} followclick={this.props.followclick} email={this.props.email} firebase={this.props.firebase} />
